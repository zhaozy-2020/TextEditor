...
def New__(name = '',title = 'Untitled'):
    ...
    lnVar = IntVar()
    yOrn = Checkbutton(toll,text = '自动换行',variable = lnVar)
    yOrn.bind('<Button-1>',LnOrNone)
#文本框
    sb = Scrollbar(frame)
    ...
    text = Text(frame,undo = True,height = 45,wrap = 'none',yscrollcommand=sb.set,insertofftime = 500,insertontime= 500)
