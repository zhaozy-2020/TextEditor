...
def New__(name = '',title = 'Untitled'):
    ...
    savebutton = Button(fr,image = saveimage,compound = TOP,text = 'save',command = save,width = 2)
    savebutton.pack(side = LEFT)

    savebutton = Button(fr,image = saveasimage,compound = TOP,text = 'save as',command = saveasButton,width = 2)
    savebutton.pack(side = LEFT)

    new_file = Button(fr,text = 'new file',command = newfile,image = saveimage2,compound = TOP,width = 2)
