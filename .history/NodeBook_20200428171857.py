...
def New__(name = '',title = 'Untitled'):
    ...
    savebutton = Button(fr,image = saveimage,compound = TOP,text = 'save',command = save,width = 4)
    ...
    openfileButton = Button(fr,text = 'open',command = Openfile,image = openimage,compound = TOP,width = 2)
