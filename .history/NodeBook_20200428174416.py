...
#文本框
    ...
    filemenu.saveadd_command(label = "Save as..",command = saveasButton)
    ...
    bianjmenu.add_command(label = "Cut",command = save)
    bianjmenu.add_command(label = "Copy",command = save)
    bianjmenu.add_command(label = "",command = save)
    bianjmenu.add_command(label = "save",command = save)
    bianjmenu.add_command(label = "save as..",command = saveasButton)
