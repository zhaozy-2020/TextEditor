...
#文本框
    ...
    optionmenu.add_command(label = "Background color",command = newfile)
    optionmenu.add_command(label = "Text color",command = Openfile)
    optionmenu.add_command(label = "Cursor color",command = save)
    optionmenu.add_command(label = "Save as..",command = saveasButton)
    main_menu.add_cascade(label = 'Options',menu = filemenu)
